...
const articles = [
  ...
  },
  {
    ...
    subtitle:
      "Bitcoin has outperformed Bitcoin and Ethereum since January thanks in part to Mad Lads NFTs",
    image:
      "https://content.fortune.com/wp-content/uploads/2023/04/Coins-Solana-6.jpg?w=1440&q=75",
  ...
  },
  {
    ...
    image:
      "https://nftnow.com/wp-content/uploads/2023/04/Mad-Lads-NFTs-1-1536x1023.jpg",
        ...
        {articles.map((article, index) => (
          ...
          >
            <div className="flex flex-col pr-1">
              <div className="text-xl tracking-wide text-zinc-50">
                {article.title}
              </div>
